...
<%
    ...
    tablesView.setLoggedInUserId(agent.getId());
    tablesView.setCurrentPage("agent");
    tablesView.setLoggedInUserType(UserType.AGENT);
%>
...
<head>
    ...
    <title><%tablesView.getPageTitle();%></title>
    <!-- Bootstrap core CSS-->
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-My fixed-top <%--<%out.print(tablesView.getNav().getCssBackgroundClass());%> sidebar fixed-top--%>"
     id="mainNav">
