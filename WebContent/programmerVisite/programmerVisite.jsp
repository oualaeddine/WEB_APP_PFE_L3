                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2 col-sm-offset-2">
                                                    <div class="choice" data-toggle="wizard-checkbox">
                                                        <input type="checkbox" name="meuble" id="meuble" value="true">
                                                        <div class="card card-checkboxes card-hover-effect">
                                                ...
                                                <div class="col-sm-2 ">
                                                    <div class="choice" data-toggle="wizard-checkbox">
                                                        <input type="checkbox" name="garage" id="garage" value="true">
                                                        <div class="card card-checkboxes card-hover-effect">
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="choice" data-toggle="wizard-checkbox">
                                                        <input type="checkbox" name="jardin" id="jardin" value="true">
                                                        <div class="card card-checkboxes card-hover-effect">
                                                ...
                                                <div class="col-sm-2 ">
                                                    <div class="choice" data-toggle="wizard-checkbox">
                                                        <input type="checkbox" name="soussol" id="soussol" value="true">
                                                        <div class="card card-checkboxes card-hover-effect">
